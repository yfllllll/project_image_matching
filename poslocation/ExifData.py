...
def get_metadata(input_file):
    ...
    if camera_model == 'FC220':
        sensor_width = 6.3
    elif camera_model == 'M3D':
        sensor_width = 17.294
    elif camera_model == 'M3TD':
        sensor_width = 10.607
    else:
        case_error = "Camera model not supported"
        print(case_error)   
        # 报错，中断
        raise ValueError(case_error)
    ...
    return focal_length, orientation, eo, maker, sensor_width
